          ...
          <el-row type="flex" justify="end" class="flex-wrap-wrap">
            <el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
              <el-form-item label="活动名称：">
                <el-input v-model="svalue1" />
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
              <el-form-item label="省市区：">
                <el-select v-model="svalue2" clearable placeholder="请选择" style="width:100%;">
                  <el-option label="浙江" value="1" />
                  <el-option label="安徽" value="2" />
                  <el-option label="江苏" value="3" />
                  <el-option label="北京" value="4" />
                </el-select>
              </el-form-item>
            </el-col>
            <el-col v-if="searchOpen" :xs="24" :sm="24" :md="12" :lg="8" :xl="8">
            ...
            <el-col :xs="24" :sm="24" :md="12" :lg="8" :xl="8" class="text-right">
              ...
              <el-button v-if="!searchOpen" type="text" @click="handleSearchOpen(true)">展开<i class="el-icon-arrow-down el-icon--right" /></el-button>
              <el-button v-else type="text" @click="handleSearchOpen(false)">收起<i class="el-icon-arrow-up el-icon--right" /></el-button>
            </el-col>
