    ...
    >
      <el-form label-width="200px" label-position="left" size="mini">
        <el-form-item label="启用顶部导航">
          <el-switch v-model="topNavEnable" />
        </el-form-item>
        <el-form-item label="固定右侧头部">
          <el-switch v-model="fiexdHeader" :disabled="topNavEnableChildDisabled" />
        </el-form-item>
        <el-form-item label="显示侧边栏LOGO">
          <el-switch v-model="sidebarLogo" :disabled="topNavEnableChildDisabled" />
        </el-form-item>
      </el-form>
    </el-drawer>
  </div>
